...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        blogs_data = [
            {
                ...
                'content': """<p>The stethoscope, a symbol of the medical profession for over two centuries, is undergoing a radical digital transformation. Artificial Intelligence (AI) is breathing new life into this classic tool, turning it into a powerful diagnostic device capable of detecting subtle cardiac abnormalities that the human ear might miss.</p>
                <br/>
            ...
            },
            {
                ...
                'author': 'Dr. Hamida Jannat',
                'category': 'Genomics',
                'content': """<p>Precision medicine is shifting the paradigm of healthcare from a "one-size-fits-all" approach to one that is tailored to individual variability in genes, environment, and lifestyle. At the heart of this shift is genomics—the study of a person's complete set of DNA.</p>
                <br/>
            ...
            },
            {
                ...
                'content': """<p>For patients with chronic conditions or those recovering from surgery, technology-enabled support systems are a lifeline. From wearable devices that monitor vital signs to mobile apps that remind patients to take their medication, technology is empowering individuals to take control of their health.</p>
                <br/>
            ...
            },
            {
                ...
                'content': """<p>Mental health is as important as physical health, yet it's often overlooked or stigmatized. Depression, anxiety, and stress-related disorders are increasingly common, affecting millions worldwide. Raising awareness and promoting open conversations about mental health is crucial.</p>
                <br/>
            ...
            },
            {
                ...
                'category': 'Nutrition',
                'content': """<p>Good nutrition is the cornerstone of a healthy life. A balanced diet rich in fruits, vegetables, whole grains, and lean proteins provides the essential nutrients your body needs to function optimally.</p>
                <br/>
            ...
            },
            {
                ...
                'content': """<p>Preventive healthcare focuses on maintaining health and preventing diseases before they occur. Regular check-ups, screenings, and vaccinations are essential components of preventive care that can save lives.</p>
                <br/>
            ...
            },
            {
                ...
                'author': 'Dr. Jenia',
                'category': 'Pediatrics',
                'content': """<p>Children's healthcare needs are unique and require specialized attention. From infancy through adolescence, regular pediatric care ensures proper growth, development, and disease prevention.</p>
                <br/>
            ...
            },
            {
                ...
                'author': 'Dr. Mehidi Hasan',
                'category': 'Elder Care',
                'content': """<p>As our population ages, elder care has become increasingly important. Providing comprehensive, compassionate care for seniors involves addressing their unique medical, emotional, and social needs.</p>
                <br/>
            ...
            },
            {
                ...
                'author': 'Dr. Haseeb Hossain',
                'category': 'Innovation',
                'content': """<p>Medical innovation is transforming healthcare at an unprecedented pace. From robotic surgery to personalized medicine, cutting-edge technologies are improving patient outcomes and revolutionizing treatment approaches.</p>
                <br/>
        ...
        for data in blogs_data:
            dt = datetime.strptime(data['date'], '%d %b %Y').date()
            
            # Delete existing blog if it exists to ensure we update the image
            BlogPost.objects.filter(title=data['title']).delete()
            ...
            try:
                ...
                if response.status_code == 200:
                    image_name = image_url.split('/')[-1].split('?')[0] # Simple extraction
                    if not image_name:
                        image_name = f"blog_{blogs_data.index(data)}.jpg"
                    ...
                    blog.image.save(image_name, image_content, save=True)
                    self.stdout.write(self.style.SUCCESS(f"Created blog with image: {data['title']}"))
                else:
                    self.stdout.write(self.style.ERROR(f"Failed to download image for {data['title']}"))
            except Exception as e:
                self.stdout.write(self.style.ERROR(f"Error creating blog {data['title']}: {str(e)}"))
